...
module.exports = {
    ...
    'Chart titles and order are correct': browser => {
        ...
        browser.expect.element('#dashboard-sections .dashboard-section:nth-child(4) #plugins-metric-overview-1 h5').text.to.be.equal('Flash');
        browser.expect.element('#dashboard-sections .dashboard-section:nth-child(4) #plugins-metric-overview-2 h5').text.to.be.equal('Unity');
    },
