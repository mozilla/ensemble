...
export default () => (
    <article id="introduction">
        <p>
            The Firefox Public Data Report is a weekly public report on the activity,
        ...
        <dl className="explanations split">
            <div>
                <dt>Empowerment</dt>
                <dd>
                    We want to empower developers, journalists, and the overall public
                    to better understand the state of the web and the direction of trends
                    in desktop web browsing.
                </dd>
            </div>
            <div>
                <dt>Transparency</dt>
        ...
        <p>
            You can learn more about this report by reading our announcement on the Mozilla blog.
        </p>
